describe("Intermission", function() {
  ...
  it('Find City, State, and Zip code', function() {
    ...
    var fixThisPattern = /^([A-Za-z\s\?.]+),?\s([A-Z][A-Z])\s(\d*-?\d*)$/;
    ...
    var state1 = matches1[2];
    var zip1   = matches1[3];

    var city2  = matches2[1];
    var state2 = matches2[2];
    var zip2   = matches2[3];

    var city3  = matches3[1];
    var state3 = matches3[2];
    var zip3   = matches3[3];

    var city4  = matches4[1];
    var state4 = matches4[2];
    var zip4   = matches4[3];
  ...
  it('Parse URL, detect invalid format', function() {
    ...
    var fixThisPattern = /^(https?|s?ftp|ssh)(:)(\/\/)?([\w\d\W]+)/;
